 ...
 *
 */
public class CommunicationAction<T extends Serializable> extends AbstractEnvironmentalAction {
	...
	this.recipientsIds = (recipientsIds != null) ? recipientsIds : new ArrayList<>();
	...
	this.recipientsIds = (recipientsIds != null) ? recipientsIds : new ArrayList<>();
	this.payload = new DefaultPayload<>(payload);
    }
	...
	this.payload = new DefaultPayload<>(action.getPayload().getPayload());
	...
	return "Message: " + this.payload + " to: " + (this.recipientsIds.isEmpty() ? "Everyone" : this.recipientsIds);
    }
}